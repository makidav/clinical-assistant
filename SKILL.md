...
description: >
  A virtual clinical team that runs a 7-phase workflow to research, analyze, deliberate, and document
  complete medical cases. Trigger WHENEVER the user presents symptoms, a diagnosis, a clinical case,
  treatment questions, requests a medical report or reviewed clinical evidence, or says things like
  "I have these symptoms", "I need a treatment plan", "find evidence on", "write a clinical report",
  "analyze this case", "what does the evidence say about", "prepare a therapeutic plan", or
  "clinical-assistant". Also trigger for multidisciplinary deliberation (clinical board), diagnostic
  risk analysis, or traceable clinical documents in PDF/DOCX. Orchestrates 26 specialized skills across
  7 phases: intake, evidence search, GRADE validation, multidisciplinary deliberation, therapeutic plan,
  final report, and a QA feedback loop. Evidence is drawn from BOTH English and Spanish literature,
  studies, and cases; output and interface are in English by default (Spanish available on request).
  FULLY SELF-CONTAINED: all protocols, templates, archetypes, and GRADE logic are embedded in this
  skill and its references/ folder. No external skill installation required.
license: CC-BY-4.0
metadata:
  version: "3.0"
