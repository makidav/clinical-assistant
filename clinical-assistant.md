...
description: >
  A self-contained Virtual Clinical Team running an 8-phase workflow — intake, evidence
  search, GRADE validation, board deliberation, treatment plan, final report, QA, and update
  — with the whole team embedded in this one skill (no other skills to install). Handles
  ...
  diagnosis, or treatment questions, or says: "I have these symptoms", "necesito un plan de
  tratamiento", "analyze this case", "escribe un informe clínico", "clinical board", "junta
  clínica", or "clinical-assistant". Fully bilingual English/Spanish. Produces research/
...
metadata:
  version: "6.0"
  self-contained: true
  integrates: 27 embedded capabilities + 13-archetype board
